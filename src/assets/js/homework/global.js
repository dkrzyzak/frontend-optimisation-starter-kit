define(['components/domReady', 'components/flexbox_fallback', 'components/placeholders.min', 'components/magnific', 'lazysizes'], function(domReady, fallback, $twitter, $placeholders, $magnificPopup) {
